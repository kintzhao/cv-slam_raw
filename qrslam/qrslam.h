...
//==============================================
    ...
    void storeDataNew(void );
    void showImageNew();
    void showSystemStateRobotNew(cv::Mat& map, Scalar rgb);
    void showSystemStateLandmarkNew(cv::Mat& map, Scalar rgb);
...
//====================== g20 =========================
    ...
    //int index_g2o_node_ = 1;    // total_mark ++
    //bool IS_FIRST_POS_;
