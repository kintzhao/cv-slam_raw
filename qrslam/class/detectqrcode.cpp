...
ofstream fConpensate_img_process("./conpensate/fConpensate_img_process.txt"); //采集mark的解析值
ofstream fThreshold_img_process("./conpensate/fThreshold_img_process.txt"); //采集mark的解析值
